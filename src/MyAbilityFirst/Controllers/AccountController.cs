...
namespace MyAbilityFirst.Controllers
{
	...
	public class AccountController : Controller
	{
		...
		//this part need to change later  [Authorize(Roles = "Admin")]
		[AllowAnonymous]
		...
		private async void AddNewUser(string userId)
		{
			...
			{
				case "Client":
					this._userService.CreateClient(aspNetUser.Id, aspNetUser.Email);
					break;
				case "CareWorker":
					this._userService.CreateCareWorker(aspNetUser.Id, aspNetUser.Email);
					break;
				case "Coordinator":
					this._userService.CreateCoordinator(aspNetUser.Id, aspNetUser.Email);
					break;
			}
		}
