	...
	public class ManageController : Controller
	{
		...
		public async Task<ActionResult> Index(ManageMessageId? message)
		{
			ViewBag.StatusMessage =
							...
							: message == ManageMessageId.ResendConfirmEmailSuccess ? "A confirmation email has been sent. Please check your email inbox."
							: "";
		...
		public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
		{
			...
			if (result.Succeeded)
			{
				...
				return RedirectToAction("Status", new { Message = ManageMessageId.ChangePasswordSuccess });
			}
			AddErrors(result);
			return View(model);
		}
		...
		//
		// GET: /Manage/Status
		public ActionResult Status(ManageMessageId? message)
		{
			...
			ViewBag.StatusMessage =
							...
							: message == ManageMessageId.AddPhoneSuccess ? "Your phone number was added."
							: message == ManageMessageId.RemovePhoneSuccess ? "Your phone number was removed."
							: message == ManageMessageId.ResendConfirmEmailSuccess ? string.Format("A confirmation email has been sent to {0}. Please check your email inbox.", loggedInUserEmail)
							: message == ManageMessageId.ForgotPasswordSuccess ? "Please check your email to reset your password."
							: "";
