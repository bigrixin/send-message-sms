...
using MyAbilityFirst.Infrastructure.Auth.EntityFramework;
using System;
...
namespace MyAbilityFirst.Infrastructure.Auth
{
	public class AspNetIdentityModule : Autofac.Module
	{
		...
		protected override void Load(ContainerBuilder builder)
		{
			...
			builder
				.RegisterType<NullDatabaseInitializer<AspNetIdentityDbContext>>()
			...
			builder.RegisterType<AspNetIdentitySmsService>();
		}
